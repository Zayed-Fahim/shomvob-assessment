...
export const Employee = (props: ComponentProps<'svg'>) => (
  <svg
    ...
    role="img"
  >
    <path d="M10 10a4 4 0 100-8 4 4 0 000 8zm3 1h-6a5.006 5.006 0 00-5 5v1a1 1 0 001 1h14a1 1 0 001-1v-1a5.006 5.006 0 00-5-5z" />
  </svg>
);
...
export const Recruitment = (props: ComponentProps<'svg'>) => (
  <svg
    ...
    role="img"
  >
    <path d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V4a2 2 0 00-2-2H6zm4 2h4a1 1 0 011 1v10a1 1 0 01-1 1h-4V4z" />
  </svg>
);
...
export const Payroll = (props: ComponentProps<'svg'>) => (
  <svg
    ...
    role="img"
  >
    <path d="M4 4a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1.5V2A1.5 1.5 0 0013 .5h-2A1.5 1.5 0 009.5 2v2H4z" />
  </svg>
);
...
export const Attendance = (props: ComponentProps<'svg'>) => (
  <svg
    ...
    role="img"
  >
    <path d="M5.5 2a.5.5 0 01.5.5v1h1.5a.5.5 0 010 1H6v1.5a.5.5 0 01-1 0V4H3.5a.5.5 0 010-1H5V2.5a.5.5 0 01.5-.5zm11 1a2 2 0 012 2V17a2 2 0 01-2 2H3.5a2 2 0 01-2-2V5a2 2 0 012-2H7v1H3.5a1 1 0 00-1 1V17a1 1 0 001 1H16.5a1 1 0 001-1V5a1 1 0 00-1-1H13V3h3.5z" />
  </svg>
);
...
export const Leave = (props: ComponentProps<'svg'>) => (
  <svg
    ...
    role="img"
  >
    <path d="M6 2a2 2 0 00-2 2v2H2a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2v-2h2a2 2 0 002-2V4a2 2 0 00-2-2H6z" />
  </svg>
);
