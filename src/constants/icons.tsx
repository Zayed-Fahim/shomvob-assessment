...
export const Flower = (props: ComponentProps<'svg'>) => (
  <svg
    version="1.1"
    id="Layer_1"
    xmlns="http://www.w3.org/2000/svg"
  ...
  >
    ...
    <g id="SVGRepo_iconCarrier">
      <path
        style={{ fill: '#53C489' }}
        d="M346.233,411.858C218.989,500.528,164.8,433.501,164.8,433.501l12.233-9.908l11.367-9.208 c56.977-22.698,83.686-24.644,105.684-15.176C316.095,408.678,346.233,411.858,346.233,411.858z"
      ></path>
      <path
        style={{ fill: '#43AC75' }}
        d="M346.233,411.858c0,0-109.719,24.478-167.681,12.091c-0.522-0.107-1.032-0.225-1.519-0.356 l11.367-9.207c56.977-22.698,83.686-24.644,105.684-15.176C316.095,408.678,346.233,411.858,346.233,411.858z"
      ></path>
      <path
        style={{ fill: '#53C489' }}
        d="M152.069,442.767l-4.058,2.729l-8.199,5.529c-9.362-9.635-55.316-66.22,28.121-179.261 c0.083,0.926,2.527,30.553,11.248,52.445C195.104,364.195,188.198,400.361,152.069,442.767z"
      ></path>
      <path
        style={{ fill: '#43AC75' }}
        d="M148.011,445.496l-8.199,5.529c-9.362-9.635-55.316-66.22,28.121-179.261 C167.933,271.765,138.685,373.604,148.011,445.496z"
      ></path>
      <g>
        <path
          style={{ fill: '#EC589B' }}
          d="M445.772,82.017c-8.78-0.131-13.125,46.152-22.796,50.044l-17.798-1.187 c-18.664,7.499-62.376,79.45-78.311,99.669c-2.682,3.393-5.292,6.775-7.772,10.121c0.724-4.105,1.388-8.329,2.005-12.601 c5.672-38.669-22.71-145.837,15.629-192.95l0.012-0.012c13.538-16.457,29.497-27.943,45.242-32.677 c11.438-3.453,22.77-3.322,32.962,1.068C439.187,13.922,450.328,45.495,445.772,82.017z"
        ></path>
        <path
          style={{ fill: '#EC589B' }}
          d="M358.135,127.603c-0.617,4.272-1.281,8.496-2.005,12.601c-18.51,24.834-31.538,48.185-31.965,66.707 l-33.52,3.461l-40.318-37.147l-0.012-0.012c-9.516-18.237-14.642-40.318-11.32-63.029c7.807-53.394,40.805-92.775,73.719-87.981 c9.077,1.329,17.193,5.885,24.027,12.898l-0.012,0.012C354.694,53.516,363.806,88.934,358.135,127.603z"
        ></path>
      </g>
      <path
        style={{ fill: '#D3468D' }}
        d="M290.645,191.617l-40.318-18.391l-0.012-0.012c-9.516-18.237-14.642-40.318-11.32-63.029 c7.807-53.394,40.805-92.775,73.719-87.981C312.714,22.204,252.344,85.351,290.645,191.617z"
      ></path>
      <path
        style={{ fill: '#EC589B' }}
        d="M445.772,82.017c9.801,0.131,18.688,2.907,25.89,8.579c26.116,20.598,20.207,71.631-13.194,114.026 c-15.567,19.744-37.542,31.597-59.22,36.545l-65.262,8.361l-9.822-42.617c0.427-18.522,13.455-41.873,31.965-66.707 c2.48-3.346,5.09-6.728,7.772-10.121C388.095,99.388,420.06,81.649,445.772,82.017z"
      ></path>
      <path
        style={{ fill: '#53C489' }}
        d="M29.532,512l-5.488-16.931l8.465-2.743c98.418-31.898,163.057-91.346,199.953-135.6 c39.915-47.875,56.649-88.361,56.812-88.764l3.358-8.24l16.482,6.716l-3.359,8.242c-0.713,1.751-17.957,43.467-59.624,93.445 c-38.397,46.055-105.676,107.927-208.135,141.134L29.532,512z"
      ></path>
      <path
        style={{ fill: '#D3468D' }}
        d="M417.805,87.772c-18.664,7.499-37.969,22.093-53.904,42.312c-2.682,3.393-5.292,6.775-7.772,10.121 c0.724-4.105,1.388-8.329,2.005-12.601c5.672-38.669-3.441-74.087-21.405-92.49l0.012-0.012 c13.538-16.457,29.497-27.943,45.242-32.677C381.984,2.424,367.84,68.657,417.805,87.772z"
      ></path>
      <path
        style={{ fill: '#74C194' }}
        d="M399.248,241.166v0.012c-21.761,32.701-64.381,46.215-101.733,30.138 c-4.509-1.934-8.745-4.224-12.708-6.823l-0.012-0.012c-29.936-19.578-44.044-56.574-34.481-91.268l40.33,18.403L399.248,241.166z"
      ></path>
      <path
        style={{ fill: '#43AC75' }}
        d="M284.795,264.482c-29.936-19.578-44.044-56.574-34.481-91.268l40.33,18.403 C259.747,209.747,284.321,263.437,284.795,264.482z"
      ></path>
    </g>
  </svg>
);
